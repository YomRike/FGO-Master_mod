...
public class NPDamageWildPower extends PowerBase {
    public static String POWER_ID = masterMod.makeId(NPDamageWildPower.class.getSimpleName());
    private static final String[] DESCRIPTIONS = (getPowerStrings(POWER_ID)).DESCRIPTIONS;

    public NPDamageWildPower(AbstractCreature owner, int amount) {
    ...
    public float atDamageGive(float damage, DamageInfo.DamageType type, AbstractCard card) {
        if (card.hasTag(CardTagsEnum.Round_Table_Knight)) {
