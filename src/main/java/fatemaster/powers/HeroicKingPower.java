...
public class HeroicKingPower extends PowerBase {
    public static String POWER_ID = masterMod.makeId(HeroicKingPower.class.getSimpleName());
    private static final String[] DESCRIPTIONS = (getPowerStrings(POWER_ID)).DESCRIPTIONS;

    public HeroicKingPower(AbstractCreature owner) {
