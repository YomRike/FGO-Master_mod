...
import fatemaster.relics.MidsummerNightDream;
...
public class MidsummerNightPatch {
    private static final String[] TEXT = CardCrawlGame.languagePack.getUIString("fatemaster:MidsummerNightDream").TEXT;
