...
public class TestTheWatersAct2 extends PhasedEvent {
    public static final String ID = masterMod.makeId("TestTheWatersAct2");
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString(ID);
    private static final String[] DESCRIPTIONS = eventStrings.DESCRIPTIONS;
    private static final String[] OPTIONS = eventStrings.OPTIONS;
    private static final String title = eventStrings.NAME;
    private int damage;
    public TestTheWatersAct2() {
        super(ID, title, "fgoMasterResources/images/event_Master/TestTheWatersAct2.png");
        ...
        this.imageEventText.setDialogOption(OPTIONS[0] + damage + OPTIONS[3]);
        ...
        switch (this.screenNum) {
            case 0:
                if (buttonPressed == 0) {
                    ...
                    this.damage += 6;
                    this.imageEventText.updateDialogOption(0, OPTIONS[1] + this.damage + OPTIONS[3]);
                    this.screenNum = 0;
