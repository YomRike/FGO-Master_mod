...
public class Technique extends fgoMasterBase {
    public static final String IMG_PATH = "fgoMasterResources/images/cards_Master/Technique.png";
    public static final String ID = masterMod.makeId(Technique.class.getSimpleName());
