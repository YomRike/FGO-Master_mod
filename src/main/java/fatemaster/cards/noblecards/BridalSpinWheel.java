...
public class BridalSpinWheel extends AbsNoblePhantasmCard {
    public static final String IMG_PATH = "fgoMasterResources/images/cards_noble/BridalSpinWheel.png";
    public static final String IMG_PATH_P = "fgoMasterResources/images/cards_noble/BridalSpinWheel_p.png";
    public static final String ID = masterMod.makeId(BridalSpinWheel.class.getSimpleName());
